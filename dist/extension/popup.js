...
function test() {
  ...
  function testMadaro() {
    ...
    if ((_document = document) !== null && _document !== void 0 && (_document$location = _document.location) !== null && _document$location !== void 0 && _document$location.href) {
      ...
      url = (_document$location$hr = document.location.href.match(/http.*\/manga\/[^/]*\//)) === null || _document$location$hr === void 0 ? void 0 : _document$location$hr[0];
    }
